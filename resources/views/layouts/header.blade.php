...
<div class="header_search">
    ...
    <form action="{{ route('search') }}" method="GET">
        <input type="text" name="query" class="form-control" placeholder="Search for Friends, Videos, and more.." autocomplete="off">
        ...
        <button type="submit" hidden>Search</button>
            ...
            <div class="right_side">
                ...
                <div class="header_widgets"> 
                    ...
                    @endif
                    <a href="/user/profile" class="is_icon" uk-tooltip="title: Profile setting">
