<script>
    ...
    .then(data => {
        ...
        data.forEach(pdf => {
            ...
            downloadButton.classList.add('bg-blue-100', 'w-23', 'flex', 'font-semibold', 'h-8', 'items-center', 'justify-center', 'mt-3', 'px-3', 'rounded-md', 'text-blue-600', 'text-sm', 'mb-1');
            downloadButton.textContent = 'Download';

            const deleteButton = document.createElement('button');
            deleteButton.classList.add('bg-red-100', 'flex', 'font-semibold', 'h-8', 'items-center', 'justify-center', 'mt-3', 'px-3', 'rounded-md', 'text-blue-600', 'text-sm', 'mb-1');
...
downloadButton.addEventListener('click', () => {
    ...
    const downloadUrl = window.location.origin + '/' + pdfRelativePath;
